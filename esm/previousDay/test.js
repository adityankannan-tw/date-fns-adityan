...
describe('previousDay', function () {
  it('returns the previous Monday given various dates after the same', function () {
    assert.deepStrictEqual(previousDay(new Date(2021, 5
    /* Jun */
    , 18), 1), new Date(2021, 5
    /* Jun */
    , 14));
    assert.deepStrictEqual(previousDay(new Date(2021, 5
    /* Jun */
    , 17), 1), new Date(2021, 5
    /* Jun */
    , 14));
    assert.deepStrictEqual(previousDay(new Date(2021, 5
    /* Jun */
    , 14), 1), new Date(2021, 5
    /* Jun */
    , 7));
    assert.deepStrictEqual(previousDay(new Date(2021, 5
    /* Jun */
