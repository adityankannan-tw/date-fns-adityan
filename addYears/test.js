...
describe('addYears', function () {
  it('adds the given number of years', function () {
    ...
    _assert.default.deepStrictEqual(result, new Date(2019, 8
    /* Sep */
    , 1));
  });
  it('accepts a timestamp', function () {
    ...
    _assert.default.deepStrictEqual(result, new Date(2026, 8
    /* Sep */
    , 1));
  });
  ...
  it('handles the leap years properly', function () {
    ...
    _assert.default.deepStrictEqual(result, new Date(2017, 1
    /* Feb */
    , 28));
  });
