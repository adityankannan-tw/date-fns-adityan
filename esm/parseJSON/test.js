...
describe('parseJSON', function () {
  it('parses a formatted new Date() back to UTC - issue 2149', function () {
    var date = new Date();
    var jsonFormat = format(date, "yyyy-MM-dd'T'HH:mm:ss.SSSxxx");
    var parsedDate = parseJSON(jsonFormat);
  ...
  it('parses a fully formed ISO date with zero offset', function () {
    ...
    var expectedDate = '2000-03-15T05:20:10.000Z';
    var parsedDate = parseJSON(zeroOffset);
    assert.strictEqual(parsedDate.toISOString(), expectedDate);
  });
