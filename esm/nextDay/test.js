...
describe('nextDay', function () {
  it('returns the following Monday given various dates before the same', function () {
    assert.deepStrictEqual(nextDay(new Date(2020, 2
    /* Mar */
    , 20), 1), new Date(2020, 2
    /* Mar */
    , 23));
    assert.deepStrictEqual(nextDay(new Date(2020, 2
    /* Mar */
    , 19), 1), new Date(2020, 2
    /* Mar */
    , 23));
    assert.deepStrictEqual(nextDay(new Date(2020, 2
    /* Mar */
    , 18), 1), new Date(2020, 2
    /* Mar */
    , 23));
    assert.deepStrictEqual(nextDay(new Date(2020, 2
    /* Mar */
    , 17), 1), new Date(2020, 2
    /* Mar */
    , 23));
    assert.deepStrictEqual(nextDay(new Date(2020, 2
    /* Mar */
    , 16), 1), new Date(2020, 2
    /* Mar */
    , 23));
    assert.deepStrictEqual(nextDay(new Date(2020, 2
    /* Mar */
    , 22), 1), new Date(2020, 2
    /* Mar */
    , 23));
    assert.deepStrictEqual(nextDay(new Date(2020, 4
    /* May */
    , 2), 1), new Date(2020, 4
    /* May */
    , 4));
