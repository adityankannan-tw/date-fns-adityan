...
describe('setDefaultOptions', function () {
  ...
  describe('locale', function () {
    it('format', function () {
      ...
      assert.deepStrictEqual(format(new Date(2014, 0, 1), 'PPPpp'), 'January 1st, 2014 at 12:00:00 AM');
      setDefaultOptions({
        locale: eo
      });
      assert.deepStrictEqual(format(new Date(2014, 0, 1), 'PPPpp'), '2014-januaro-01 00:00:00'); // Manually set `locale` take priority over `defaultOptions.locale`

      assert.deepStrictEqual(format(new Date(2014, 0, 1), 'PPPpp', {
        locale: enUS
      }), 'January 1st, 2014 at 12:00:00 AM');
    });
    it('formatDistance', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(formatDistance(new Date(2014, 0, 1), new Date(2015, 0, 1)), 'about 1 year');
      setDefaultOptions({
        locale: eo
      });
      assert.deepStrictEqual(formatDistance(new Date(2014, 0, 1), new Date(2015, 0, 1)), 'proksimume 1 jaro'); // Manually set `locale` take priority over `defaultOptions.locale`

      assert.deepStrictEqual(formatDistance(new Date(2014, 0, 1), new Date(2015, 0, 1), {
        locale: enUS
      }), 'about 1 year');
    });
    it('formatDistanceStrict', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(formatDistanceStrict(new Date(2014, 0, 1), new Date(2015, 0, 1)), '1 year');
      setDefaultOptions({
        locale: eo
      });
      assert.deepStrictEqual(formatDistanceStrict(new Date(2014, 0, 1), new Date(2015, 0, 1)), '1 jaro'); // Manually set `locale` take priority over `defaultOptions.locale`

      assert.deepStrictEqual(formatDistanceStrict(new Date(2014, 0, 1), new Date(2015, 0, 1), {
        locale: enUS
      }), '1 year');
    });
    it('formatDuration', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(formatDuration({
        years: 1
      }), '1 year');
      setDefaultOptions({
        locale: eo
    ...
    it('formatRelative', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(formatRelative(new Date(2014, 0, 1), new Date(2014, 0, 2)), 'yesterday at 12:00 AM');
      setDefaultOptions({
        locale: eo
      });
      assert.deepStrictEqual(formatRelative(new Date(2014, 0, 1), new Date(2014, 0, 2)), 'hieraŭ je 00:00'); // Manually set `locale` take priority over `defaultOptions.locale`

      assert.deepStrictEqual(formatRelative(new Date(2014, 0, 1), new Date(2014, 0, 2), {
        locale: enUS
    ...
    it('isMatch', function () {
      ...
      assert(isMatch('2014-januaro-01 00:00:00', 'PPPpp')); // Manually set `locale` take priority over `defaultOptions.locale`
    ...
    it('parse', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(parse('January 1st, 2014 at 12:00:00 AM', 'PPPpp', new Date()), new Date(2014, 0, 1));
      setDefaultOptions({
        locale: eo
      });
      assert.deepStrictEqual(parse('2014-januaro-01 00:00:00', 'PPPpp', new Date()), new Date(2014, 0, 1)); // Manually set `locale` take priority over `defaultOptions.locale`

      assert.deepStrictEqual(parse('January 1st, 2014 at 12:00:00 AM', 'PPPpp', new Date(), {
        locale: enUS
      }), new Date(2014, 0, 1));
    });
  });
  describe('weekStartsOn', function () {
    it('differenceInCalendarWeeks', function () {
      // For reference: not setting any options
      assert.strictEqual(differenceInCalendarWeeks(new Date(2014, 6
      /* Jul */
    ...
    it('eachWeekOfInterval', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(eachWeekOfInterval({
    ...
    it('endOfWeek', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(endOfWeek(new Date(2014, 8
      /* Sep */
    ...
    it('getWeekOfMonth', function () {
      // For reference: not setting any options
      assert.strictEqual(getWeekOfMonth(new Date(2017, 10
      /* Nov */
      , 15)), 3);
      setDefaultOptions({
        weekStartsOn: 1
      });
      assert.strictEqual(getWeekOfMonth(new Date(2017, 9
      /* Oct */
    ...
    it('getWeeksInMonth', function () {
      // For reference: not setting any options
      assert.strictEqual(getWeeksInMonth(new Date(2015, 1
      /* Feb */
      , 8, 18, 0)), 4);
      setDefaultOptions({
        weekStartsOn: 1
    ...
    it('isSameWeek', function () {
      // For reference: not setting any options
      assert.strictEqual(isSameWeek(new Date(2014, 7
      /* Aug */
      , 31), new Date(2014, 8
      /* Sep */
      , 4)), true);
    ...
    it('lastDayOfWeek', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(lastDayOfWeek(new Date(2014, 8
      /* Sep */
      , 2, 11, 55, 0)), new Date(2014, 8
      /* Sep */
      , 6));
    ...
    it('setDay', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(setDay(new Date(2014, 8
      /* Sep */
      , 1), 0), new Date(2014, 7
      /* Aug */
      , 31));
    ...
    it('startOfWeek', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(startOfWeek(new Date(2014, 8
      /* Sep */
  ...
  describe('firstWeekContainsDate', function () {
    it('format', function () {
      // For reference: not setting any options
      assert.strictEqual(format(new Date(1986, 3
      /* Apr */
    ...
    it('getWeek', function () {
      // For reference: not setting any options
      assert.strictEqual(getWeek(new Date(2005, 0
      /* Jan */
      , 2)), 2);
      setDefaultOptions({
        weekStartsOn: 1,
    ...
    it('getWeekYear', function () {
      // For reference: not setting any options
      assert.strictEqual(getWeekYear(new Date(2004, 11
      /* Dec */
      , 26)), 2005);
      setDefaultOptions({
        weekStartsOn: 1,
    ...
    it('parse', function () {
      ...
      assert.deepStrictEqual(parse('2018', 'Y', referenceDate), new Date(2017, 11
      /* Dec */
      , 31));
      setDefaultOptions({
        weekStartsOn: 1,
      ...
      assert.deepStrictEqual(parse('2018', 'Y', referenceDate), new Date(2018, 0
      /* Jan */
      , 1)); // Manually set `firstWeekContainsDate` take priority over `defaultOptions.firstWeekContainsDate`

      assert.deepStrictEqual(parse('2018', 'Y', referenceDate, {
        weekStartsOn: 0,
        firstWeekContainsDate: 1
      }), new Date(2017, 11
      /* Dec */
    ...
    it('setWeek', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(setWeek(new Date(2005, 0
      /* Jan */
    ...
    it('setWeekYear', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(setWeekYear(new Date(2010, 0
      /* Jan */
    ...
    it('startOfWeekYear', function () {
      // For reference: not setting any options
      assert.deepStrictEqual(startOfWeekYear(new Date(2005, 6
      /* Jul */
      , 2)), new Date(2004, 11
      /* Dec */
      , 26, 0, 0, 0, 0));
