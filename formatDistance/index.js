...
var _index8 = _interopRequireDefault(require("../_lib/defaultLocale/index.js"));

var _index9 = require("../_lib/defaultOptions/index.js");

var _index10 = _interopRequireDefault(require("../_lib/getTimezoneOffsetInMilliseconds/index.js"));
...
function formatDistance(dirtyDate, dirtyBaseDate, options) {
  ...
  var locale = (_ref = (_options$locale = options === null || options === void 0 ? void 0 : options.locale) !== null && _options$locale !== void 0 ? _options$locale : defaultOptions.locale) !== null && _ref !== void 0 ? _ref : _index8.default;
  ...
  var localizeOptions = (0, _index6.default)((0, _index7.default)(options), {
  ...
  var offsetInSeconds = ((0, _index10.default)(dateRight) - (0, _index10.default)(dateLeft)) / 1000;
  ...
  if (minutes < 2) {
    ...
    var days = Math.round(minutes / _index2.minutesInDay);
  ...
  if (months < 12) {
    var nearestMonth = Math.round(minutes / _index2.minutesInMonth);
