...
var _index3 = _interopRequireDefault(require("../isLastDayOfMonth/index.js"));
...
function differenceInMonths(dirtyDateLeft, dirtyDateRight) {
  ...
  if (difference < 1) {
    ...
    var isLastMonthNotFull = (0, _index.default)(dateLeft, dateRight) === -sign; // Check for cases of one full calendar month

    if ((0, _index3.default)((0, _index4.default)(dirtyDateLeft)) && difference === 1 && (0, _index.default)(dirtyDateLeft, dateRight) === 1) {
