...
describe('differenceInMonths', function () {
  it('returns the number of full months between the given dates', function () {
    var result = differenceInMonths(new Date(2012, 6
    /* Jul */
  ...
  it('returns a negative number if the time value of the first date is smaller', function () {
    var result = differenceInMonths(new Date(2011, 6
    /* Jul */
  ...
  it('accepts timestamps', function () {
    var result = differenceInMonths(new Date(2014, 7
    /* Aug */
  ...
  describe('edge cases', function () {
    it('it returns diff of 1 month between Feb 28 2021 and Jan 30 2021', function () {
      var result = differenceInMonths(new Date(2021, 1
      /* Feb */
      , 28), new Date(2021, 0
      /* Jan */
      , 30));
    ...
    it('it returns diff of 1 month between Nov, 30 2021 and Oct, 31 2021', function () {
      var result = differenceInMonths(new Date(2021, 10
      /* Nov */
      , 30), new Date(2021, 9
      /* Oct */
      , 31));
    ...
    it('it returns diff of 1 month between Oct, 31 2021 and Sep, 30 2021', function () {
      var result = differenceInMonths(new Date(2021, 9
      /* Oct */
      , 31), new Date(2021, 8
      /* Sep */
      , 30));
    ...
    it('it returns diff of -1 month between Sep, 30 2021 and Oct, 31 2021', function () {
      var result = differenceInMonths(new Date(2021, 8
      /* Sep */
      , 30), new Date(2021, 9
      /* Oct */
      , 31));
    ...
    it('the same for the swapped dates', function () {
      var result = differenceInMonths(new Date(2014, 6
      /* Jul */
      , 31), new Date(2014, 7
      /* Aug */
      , 1));
    ...
    it('the days of months of the given dates are the same', function () {
      var result = differenceInMonths(new Date(2014, 8
      /* Sep */
      , 6), new Date(2014, 7
      /* Aug */
      , 6));
  ...
  it('returns NaN if the first date is `Invalid Date`', function () {
    var result = differenceInMonths(new Date(NaN), new Date(2017, 0
    /* Jan */
    , 1));
    assert(isNaN(result));
  });
  it('returns NaN if the second date is `Invalid Date`', function () {
    var result = differenceInMonths(new Date(2017, 0
    /* Jan */
    , 1), new Date(NaN));
    assert(isNaN(result));
  });
  ...
  describe('edge cases', function () {
    it('returns the number of full months between the given dates - end of Feb', function () {
      assert(differenceInMonths(new Date(2012, 1
      /* Feb */
    ...
    assert(differenceInMonths(new Date(2021, 1
    /* Feb */
