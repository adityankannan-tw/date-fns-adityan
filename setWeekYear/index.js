...
var _index3 = _interopRequireDefault(require("../startOfWeekYear/index.js"));
...
function setWeekYear(dirtyDate, weekYear, options) {
  ...
  var diff = (0, _index2.default)(date, (0, _index3.default)(date, options));
  var firstWeek = (0, _index.default)(dirtyDate, 0);
  firstWeek.setFullYear(weekYear, 0, firstWeekContainsDate);
  firstWeek.setHours(0, 0, 0, 0);
  date = (0, _index3.default)(firstWeek, options);
