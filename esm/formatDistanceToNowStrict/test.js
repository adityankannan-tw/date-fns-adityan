...
describe('formatDistanceToNowStrict', function () {
  ...
  describe('when the unit option is supplied', function () {
    describe('second', function () {
      ...
      it('120 seconds', function () {
        var result = formatDistanceToNowStrict(new Date(1986, 3, 4, 10, 34, 0), {
          unit: 'second'
        });
    ...
    describe('minute', function () {
      ...
      it('5 minutes', function () {
        var result = formatDistanceToNowStrict(new Date(1986, 3, 4, 10, 37, 0), {
          unit: 'minute'
        });
        assert(result === '5 minutes');
      });
      it('120 minutes', function () {
        var result = formatDistanceToNowStrict(new Date(1986, 3, 4, 12, 32, 0), {
          unit: 'minute'
        });
    ...
    describe('hour', function () {
      ...
      it('5 hours', function () {
        var result = formatDistanceToNowStrict(new Date(1986, 3, 4, 15, 32, 0), {
          unit: 'hour'
        });
        assert(result === '5 hours');
      });
      it('48 hours', function () {
        var result = formatDistanceToNowStrict(new Date(1986, 3, 6, 10, 32, 0), {
          unit: 'hour'
        });
    ...
    describe('day', function () {
      ...
      it('5 days', function () {
        var result = formatDistanceToNowStrict(new Date(1986, 3, 9, 10, 32, 0), {
          unit: 'day'
        });
        assert(result === '5 days');
      });
      it('60 days', function () {
        var result = formatDistanceToNowStrict(new Date(1986, 5, 3, 10, 32, 0), {
          unit: 'day'
        });
    ...
    describe('month', function () {
      ...
      it('5 months', function () {
        var result = formatDistanceToNowStrict(new Date(1986, 7, 4, 10, 32, 0), {
          unit: 'month'
        });
        assert(result === '4 months');
      });
      it('24 months', function () {
        var result = formatDistanceToNowStrict(new Date(1988, 3, 4, 10, 32, 0), {
          unit: 'month'
        });
    ...
    describe('year', function () {
      it('returns `1 year` - see issue 2388', function () {
        var result = formatDistanceToNowStrict(new Date(1985, 3, 4, 10, 32, 0));
        assert(result === '1 year');
      });
      it('returns `2 years` - see issue 2388', function () {
        var result = formatDistanceToNowStrict(new Date(1984, 3, 4, 10, 32, 0));
      ...
      it('5 years', function () {
        var result = formatDistanceToNowStrict(new Date(1991, 3, 4, 15, 32, 0), {
          unit: 'year'
        });
        assert(result === '5 years');
      });
  ...
  it('accepts timestamps', function () {
    var result = formatDistanceToNowStrict(new Date(1986, 3, 4, 11, 32, 0).getTime());
    assert(result === '1 hour');
  });
    ...
    describe('does not contain `formatDistance` property', function () {
      it('throws `RangeError`', function () {
        ...
        var block = function block() {
          return formatDistanceToNowStrict(new Date(1986, 3, 4, 10, 37, 0), {
            unit: 'minute',
            // @ts-expect-error
            locale: customLocale
          });
  ...
  describe('edge cases', function () {
    it('detects unit correctly for short months', function () {
      var result = formatDistanceToNowStrict(new Date(1986, 2
      /* Mar */
      , 7));
  ...
  it('throws `RangeError` if the date is `Invalid Date`', function () {
    assert.throws(formatDistanceToNowStrict.bind(null, new Date(NaN)), RangeError);
  });
});