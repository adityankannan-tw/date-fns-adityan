...
describe('min', function () {
  ...
  it('returns the earliest date', function () {
    var result = min([new Date(1989, 6
    /* Jul */
    , 10), new Date(1987, 1
    /* Feb */
    , 11)]);
    assert.deepStrictEqual(result, new Date(1987, 1
    /* Feb */
    , 11));
  });
  it('accepts array with more than 2 entries', function () {
    var result = min([new Date(1987, 1
    /* Feb */
    , 11), new Date(1989, 6
    /* Jul */
    , 10), new Date(1985, 6
    ...
    /* Jan */
    , 1)]);
    assert.deepStrictEqual(result, new Date(1985, 6
    /* Jul */
    , 2));
  });
