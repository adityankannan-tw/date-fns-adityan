...
var _index2 = _interopRequireDefault(require("../getDefaultOptions/index.js"));
...
var _index5 = _interopRequireDefault(require("../_lib/assign/index.js"));

var _index6 = _interopRequireDefault(require("../_lib/format/longFormatters/index.js"));

var _index7 = require("../_lib/protectedTokens/index.js");

var _index8 = require("./_lib/parsers/index.js");
...
function parse(dateString, formatString, dirtyReferenceDate, options) {
  ...
  var defaultOptions = (0, _index2.default)();
  ...
  if (formatString === '') {
    if (dateString === '') {
      return (0, _index4.default)(dirtyReferenceDate);
    } else {
      return (0, _index.default)(dirtyReferenceDate, NaN);
    }
  }
  ...
  var tokens = formatString.match(longFormattingTokensRegExp).map(function (substring) {
    ...
    if (firstCharacter in _index6.default) {
  ...
  try {
    var _loop = function _loop() {
      ...
      if (!(options !== null && options !== void 0 && options.useAdditionalWeekYearTokens) && (0, _index7.isProtectedWeekYearToken)(token)) {
        (0, _index7.throwProtectedError)(token, formatString, dateString);
      }
      ...
      var parser = _index8.parsers[firstCharacter];
      ...
      if (parser) {
        ...
        if (!parseResult) {
          return {
            v: (0, _index.default)(dirtyReferenceDate, NaN)
          };
        }
  ...
  var date = (0, _index4.default)(dirtyReferenceDate);
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      if (Array.isArray(result)) {
        date = result[0];
        (0, _index5.default)(flags, result[1]); // Result is date
      } else {
        date = result;
      }
    }
  ...
  return (0, _index.default)(dirtyReferenceDate, date);
}
